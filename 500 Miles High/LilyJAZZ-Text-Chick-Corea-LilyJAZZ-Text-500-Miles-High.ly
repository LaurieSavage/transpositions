...
\header {
  title = \markup { \fontsize #3 \override #'(font-name . "LilyJAZZ Text")" 500 Miles High"}
  composer =\markup { \fontsize #3 \override #'(font-name . "LilyJAZZ Text") "Chick Corea "}
  piece = \markup { \fontsize #3 \override #'(font-name . "LilyJAZZ Text") ""}
  tagline = \markup { \fontsize #2 \override #'(font-name . "LilyJAZZ Text") "Laurie Savage, " \today }
}
