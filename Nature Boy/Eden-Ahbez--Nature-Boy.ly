...
\header {
  title = \markup { \fontsize #3 \override #'(font-name . "LilyJAZZ Text")"Nature Boy"}
  composer =\markup { \fontsize #3 \override #'(font-name . "LilyJAZZ Text") "eden ahbez"}
    piece = \markup { \fontsize #3 \override #'(font-name . "LilyJAZZ Text") "Slow"}
