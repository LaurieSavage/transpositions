...
\alternative{{d1 r2 r4 r8 a8}{d1 R1 \bar "|."}}
}

vocalChords = \transpose d b {\chordNames}
vocalMelody = \transpose d b {\melody}
...
\book {
  ...
  \score {
    <<
      ...
      \new Staff \with { instrumentName = "C insts." }{\vocalMelody} %\melody
    >>
    \layoutScore
  }
}
...
\book {
  ...
  \score {
    <<
      ...
      \new Staff \with { instrumentName = "Tenor Sax" } \transpose bes c' \vocalMelody %\melody
    >>
    \layoutScore
  }
}
...
\book {
  ...
  \score {
    <<
      \new ChordNames \transpose bes c \vocalChords %\chordNames
      \new Staff \with { instrumentName = "Trumpet" } \transpose bes c' \vocalMelody %\melody
    >>
    \layoutScore
  }
}
...
\book {
  ...
  \score {
    <<
      ...
      \new Staff \with { instrumentName = "Eb Sax" } \transpose ees c \vocalMelody %\melody
    >>
    \layoutScore
  }
}
