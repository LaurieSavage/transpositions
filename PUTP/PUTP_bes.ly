...
\header {
  ...
  subtitle = "B flat trumpet, lead part"
  %meter = ""
...
partA = \relative c' {
  ...
  \repeat volta 3 {
    ...
    f8 d c16 d r16 f16~ f8 d c16-. d-. r8 \coda |
  }
  \alternative{
    { r1 r1 r1 r1 \break}
    {
  ...
  \repeat volta 2 {
    g,16 g r8 r4 r2
    b16 bes a16 a16 r4 r2
    g16 g r8 r4 r2
    b16 bes a16 a16 r4 r2 \break
  }
  ...
  \repeat volta 3 {
      g'16 (f g f) d8-. g16 (f g f) c8-. r4 |
      g'16 (f g f) d8-. g16 (f g f) c8-. r4^\markup {\box"x3"} |
  }
  g'16 (f g f) d8-. g16 (f g f) c8-. r4
...
\score {
  %\new StaffGroup
  <<
    \new ChordNames \transpose bes ees \chordNames
    \new Staff {
      %\set Staff.instrumentName="Part 1"
      \transpose bes' ees \partA
    }
