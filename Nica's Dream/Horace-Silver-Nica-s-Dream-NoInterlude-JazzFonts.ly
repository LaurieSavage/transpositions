...
%   }}}}
%
%   \markup { \column { \wordwrap { \vspace #2 More text More text More text More text
% More text More text More text More text More text More text More
% text More text More text More text More text More text More text
% More text More text More text More text More text More text More text }}}
%
  %   \score{
  %     <<
  %       \new ChordNames \interludeC
  %       \new Staff \interludeM
  %     >>
  %   }
}
...
\bookpart {
  ...
  \score {
    <<
      \new ChordNames \transpose bes g \chordNames
      \new Staff  \transpose bes g  \melody
    >>
  }
}
...
\bookpart {
  ...
  \score {
    ...
    <<
      ...
      \new Staff  \transpose bes a' \melody
    >>
...
\bookpart {
  ...
  \score {
    <<
      \new ChordNames \transpose bes d  \chordNames
      \new Staff  \transpose bes d' \melody
    >>
