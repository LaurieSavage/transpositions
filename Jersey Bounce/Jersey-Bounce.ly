...
melody = \relative c'' {
  ...
  \break
  \mark \default
  d4-.\mark \markup { \with-color #red \musicglyph "scripts.segno" } %\segno
  r8 d8~ d2
  d8 c g' d~ d2
  c4-. r8 c8~ c2
  c8 bes f' c~ c2 \break
...
LastRiff = \relative c'' {
  \showStartRepeatBar \bar "[|:-|"
  \global
  c4\mark \markup {"After all solos"} bes8 g a c bes g
  a c bes g a c a bes
  b4. g8-. r2
  r2 r4 c16 d c a
  bes4. g8-. r2
...
Coda = \relative c'' {
  ...
  a8 c d f ees4 des8 f8
  r2 r4 r8 gis,8
  a8 c d f ees4 des8 <d g>8~_"Tenor plays lower note"
